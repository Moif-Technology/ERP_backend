/**
 * Insert 15-08-2026 Noir Fade DXB sales + Z-close.
...
const GROUP_ID = 1;
const BILL_DATE = '2026-08-15';
const CLOSE_DATE = '2026-08-15 16:45:00';
const CLOSE_STAFF_ID = 1;

const STAFF = { Shanid: 1, Faslu: 2, Ajmal: 3 };

const BILLS = [
  { staffName: 'Shanid', staffId: STAFF.Shanid, payMode: 'CREDITCARD', amount: 420, time: '10:15:00' },
  { staffName: 'Shanid', staffId: STAFF.Shanid, payMode: 'CASH', amount: 85, time: '10:40:00' },
  { staffName: 'Ajmal', staffId: STAFF.Ajmal, payMode: 'CREDITCARD', amount: 320, time: '12:05:00' },
  { staffName: 'Ajmal', staffId: STAFF.Ajmal, payMode: 'CASH', amount: 100, time: '12:30:00' },
  { staffName: 'Faslu', staffId: STAFF.Faslu, payMode: 'CREDITCARD', amount: 385, time: '16:10:00' },
  { staffName: 'Faslu', staffId: STAFF.Faslu, payMode: 'CASH', amount: 195, time: '16:35:00' },
];
...
async function main() {
  ...
  try {
    ...
    for (const bill of BILLS) {
      ...
      await client.query(
        `INSERT INTO ops.sales_master (
            ...
            'PENDING','SALE','seed_15aug','seed_15aug'
          )`,
        [
    ...
    if (cash !== 380 || card !== 1125) {
      throw new Error(`Totals mismatch: cash=${cash} card=${card} (expected cash 380 card 1125)`);
    }
