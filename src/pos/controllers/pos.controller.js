...
import { resolvePosPrivilegesForStaff } from '../../services/entitlement.service.js';
...
/**
 * POST /api/pos/login
 * Legacy Flutter POS shape + JWTs.
 * Body: { login, password } or { username, password }
 * Delegates to shared auth (same staff/company model as ERP web).
 */
