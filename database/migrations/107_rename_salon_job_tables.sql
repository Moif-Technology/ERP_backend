...
-- Rename ops.salon_job_master / ops.salon_job_child → ops.job_master / ops.job_child
-- for databases that already applied 104–106 under the old names.
-- Idempotent: no-op when new names already exist.
...
-- Align constraint / index names when they still use the old prefix.
DO $$
BEGIN
